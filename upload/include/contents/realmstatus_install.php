...
$scripter = 'Siggi';        // Name des Autors des Moduls
$script_name = 'Realm Status Box';    // Name des Moduls
...
if (!isset($_POST['do'])) {
    ...
    ?>
    <form action="index.php?realmstatus_install" method="POST">
    ...
    $error = '';
    $sql_file = implode('', file('include/contents/realmstatus.sql'));
        ...
        <tr class="Cmite">
            <td colspan="3" align="center">
                ...
                if (!empty($error)) {
                    ...
                    if (@unlink('include/contents/realmstatus_install.php') && @unlink('include/contents/realmstatus.sql')) {
                        $erfolg .= '<br /><br />Diese Installationsdateien wurden erfolgreich gel&ouml;scht. Es muss nichts mehr getan werden.';
                    } else {
                        $erfolg .= '<br /><br /><strong>Die Installationsdateien konnten nicht automatisch gel&ouml;scht werden. L&ouml;schen Sie folgende Dateien:</strong><br /><br /><i>include/contents/realmstatus_install.php</i><br /><i>include/contents/realmstatus.sql</i>';
                    }
